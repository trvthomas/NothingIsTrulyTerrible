const scenes = [
    ...
    },
    {
        ...
        elements: [
            ...
            { asset: "scene-3ab-net.webp", top: 0, left: 76, width: 30, depth: 0.25, animation: "wobble-y", animationDuration: 3 },
    ...
    },
    {
        ...
        elements: [
            ...
            { asset: "scene-4c-quill.webp", top: 16, left: 66, width: 20, depth: 0.3, animation: "move-diagonal-2", animationDuration: 1 },
    ...
    },
    {
        ...
        elements: [
            // Big
            { asset: "scene-5a-fruit1.webp", top: 18, left: 12, width: 12, depth: 0.18, animation: "heart-beat", animationDuration: 6 },
            { asset: "scene-5a-fruit4.webp", top: 16, left: 78, width: 12, depth: 0.18, animation: "rotate-half", animationDuration: 2, animationReverse: true },
            { asset: "scene-5a-fruit2.webp", top: 40, left: 9, width: 12, depth: 0.18 , animation: "rotate-half", animationDuration: 2},
            { asset: "scene-5a-fruit3.webp", top: 51, left: 80, width: 12, depth: 0.18, animation: "heart-beat", animationDuration: 6, animationReverse: true },
            { asset: "scene-5a-fruit5.webp", top: 66, left: 16, width: 12, depth: 0.18, animation: "heart-beat", animationDuration: 4 },
            { asset: "scene-5a-fruit6.webp", top: 64, left: 65, width: 12, depth: 0.18, animation: "rotate-half", animationDuration: 3 },
            // Small
            { asset: "scene-5a-fruit3.webp", top: 18, left: 27, width: 5, depth: 0.4, animation: "vibrate", animationDuration: 2, animationReverse: true },
            { asset: "scene-5a-fruit6.webp", top: 14, left: 40, width: 6, depth: 0.3, animation: "rotate-full", animationDuration: 10 },
            { asset: "scene-5a-fruit1.webp", top: 19, left: 50, width: 5, depth: 0.4, animation: "rotate-full", animationDuration: 10, animationReverse: true },
            { asset: "scene-5a-fruit2.webp", top: 21, left: 60, width: 5, depth: 0.4, animation: "vibrate", animationDuration: 2 },
            { asset: "scene-5a-fruit5.webp", top: 26, left: 70, width: 6, depth: 0.3, animation: "rotate-half", animationDuration: 1.4 },
            { asset: "scene-5a-fruit4.webp", top: 65, left: 32, width: 5, depth: 0.4, animation: "rotate-full", animationDuration: 12, animationReverse: true },
            { asset: "scene-5a-fruit3.webp", top: 71, left: 40, width: 6, depth: 0.3, animation: "vibrate", animationDuration: 1.8, animationReverse: true },
            { asset: "scene-5a-fruit2.webp", top: 70, left: 48, width: 5, depth: 0.4, animation: "rotate-half", animationDuration: 1 },
            { asset: "scene-5a-fruit1.webp", top: 74, left: 57, width: 5, depth: 0.4, animation: "rotate-full", animationDuration: 9 },
        ],
        buttons: [
    ...
    },
    {
        ...
        elements: [
            ...
            { asset: "scene-5b-silhouette-sad.webp", top: 59, left: 18, width: 14, depth: 0.2, animation: "heart-beat", animationDuration: 5 },
            { asset: "scene-5b-silhouette-happy.webp", top: 54, left: 66, width: 14, depth: 0.2, animation: "move-y", animationDuration: 4 },
            { asset: "scene-5b-item1.webp", top: 64, left: 12, width: 7, depth: 0.3, animation: "wobble-x", animationDuration: 3 },
            { asset: "scene-5b-item2.webp", top: 44, left: 21, width: 7, depth: 0.46, animation: "wobble-x", animationDuration: 2.8 },
            { asset: "scene-5b-item3.webp", top: 58, left: 33, width: 7, depth: 0.38, animation: "wobble-x", animationDuration: 3, animationReverse: true },
            { asset: "scene-5a-fruit1.webp", top: 62, left: 59, width: 7, depth: 0.3, animation: "rotate-half", animationDuration: 1.7, animationReverse: true },
            { asset: "scene-5a-fruit2.webp", top: 45, left: 70, width: 6, depth: 0.46, animation: "rotate-full", animationDuration: 8, animationReverse: true },
            { asset: "scene-5a-fruit3.webp", top: 64, left: 81, width: 7, depth: 0.38, animation: "rotate-half", animationDuration: 2, animationReverse: true },
        ],
        buttons: [
    ...
    },
    {
        ...
        elements: [
            ...
            { asset: "scene-6c-droplet4.webp", top: 62, left: 28, width: 10, depth: 0.05, animation: "blink-subtle", animationDuration: 3 },
            { asset: "scene-6c-droplet2.webp", top: 59, left: 48, width: 12, depth: 0.05, animation: "blink-subtle", animationDuration: 2.4 },
            { asset: "scene-6c-droplet3.webp", top: 72, left: 40, width: 8, depth: 0.05, animation: "blink-subtle", animationDuration: 3.6 },
            { asset: "scene-6c-glass.webp", top: 20, left: 15, width: 17, depth: 0.4, animation: "move-diagonal-1", animationDuration: 3, animationReverse: true },
            { asset: "scene-6c-hand.webp", top: 43, left: 30, width: 38, depth: 0.6, animation: "move-x", animationDuration: 4, animationReverse: true }
        ],
        buttons: [
    ...
    },
    {
        ...
        elements: [
            // Tiny
            { asset: "scene-7a-leafdecor1.webp", top: 13, left: 36, width: 5, depth: 0.6, animation: "heart-beat-subtle", animationDuration: 1.5, animationReverse: true },
            { asset: "scene-7a-leafdecor6.webp", top: 26, left: 40, width: 5, depth: 0.7, animation: "heart-beat-subtle", animationDuration: 1 },
            { asset: "scene-7a-leafdecor4.webp", top: 30, left: 55, width: 5, depth: 0.5 },
            { asset: "scene-7a-leafdecor3.webp", top: 20, left: 64, width: 5, depth: 0.7, animation: "heart-beat-subtle", animationDuration: 1.5, animationReverse: true },
            { asset: "scene-7a-leafdecor5.webp", top: 16, left: 74, width: 5, depth: 0.6 },
            { asset: "scene-7a-leafdecor4.webp", top: 42, left: 80, width: 5, depth: 0.5, animation: "heart-beat-subtle", animationDuration: 1.3 },
            { asset: "scene-7a-leafdecor1.webp", top: 56, left: 73, width: 5, depth: 0.5, animation: "heart-beat-subtle", animationDuration: 1.8, animationReverse: true },
            ...
            { asset: "scene-7a-leafdecor3.webp", top: 80, left: 60, width: 5, depth: 0.7, animation: "heart-beat-subtle", animationDuration: 1.2, animationReverse: true },
            { asset: "scene-7a-leafdecor2.webp", top: 64, left: 36, width: 5, depth: 0.6, animation: "heart-beat-subtle", animationDuration: 1.2 },
            // Large
            { asset: "scene-7a-leaf3.webp", top: 8, left: 45, width: 16, depth: 0.38, animation: "shake-m", animationDuration: 1.5, animationReverse: true },
            { asset: "scene-7a-leaf2.webp", top: 20, left: 74, width: 15, depth: 0.38, animation: "shake-m", animationDuration: 1.5 },
            { asset: "scene-7a-leaf1.webp", top: 67, left: 68, width: 18, depth: 0.38, animation: "shake-m", animationDuration: 1.7 },
            { asset: "scene-7a-leaf4.webp", top: 63, left: 38, width: 22, depth: 0.38, animation: "shake-m", animationDuration: 1.2, animationReverse: true },
            
            { asset: "scene-7a-silhouette.webp", top: 58, left: 20, width: 11, depth: 0.3, animation: "move-y", animationDuration: 4 },
            { asset: "scene-7a-spotlight.webp", top: 0, left: 10, width: 30, depth: 0.4, animation: "blink-subtle", animationDuration: 0.9 },
        ],
        buttons: [
    ...
    },
    {
        ...
        elements: [
            ...
            { asset: "scene-7b-explosion.webp", top: 3, left: 59, width: 37, depth: 0.1, animation: "flicker-subtle", animationDuration: 3 },
            { asset: "scene-7b-jet1.webp", top: 20, left: 60, width: 11, depth: 0.2, animation: "move-x", animationDuration: 1.9, animationReverse: true },
    ...
    },
    {
        ...
        elements: [
            ...
            { asset: "scene-7c-chest2.webp", top: 7.68, left: 38, width: 39.4, depth: 0.3, animation: "move-y", animationDuration: 7 },
            { asset: "scene-7c-letter1.webp", top: 34, left: 39, width: 14, depth: 0.43, animation: "wobble-y", animationDuration: 6 },
            { asset: "scene-7c-letter2.webp", top: 10, left: 46, width: 13, depth: 0.52, animation: "move-y", animationDuration: 3 },
            { asset: "scene-7c-letter3.webp", top: 8, left: 10, width: 14, depth: 0.52, animation: "shake-m", animationDuration: 2 },
            { asset: "scene-7c-letter4.webp", top: 22, left: 26, width: 14, depth: 0.43, animation: "heart-beat", animationDuration: 5 },
            { asset: "scene-7c-letter5.webp", top: 29, left: 56, width: 10.5, depth: 0.52, animation: "move-y", animationDuration: 6 },
            { asset: "scene-7c-letter6.webp", top: 30, left: 78, width: 14, depth: 0.43, animation: "shake-tr", animationDuration: 3 },
            { asset: "scene-7c-letter7.webp", top: 2, left: 67, width: 14, depth: 0.43, animation: "move-x", animationDuration: 5 },
            { asset: "scene-7c-letter8.webp", top: 46, left: 12, width: 14, depth: 0.52, animation: "wobble-x", animationDuration: 2, animationReverse: true },
            { asset: "scene-7c-letter-blank6.webp", top: 44, left: 51.5, width: 6, depth: 0.3, animation: "rotate-half", animationDuration: 3 },
            ...
            { asset: "scene-7c-letter-blank4.webp", top: 20, left: 62, width: 6, depth: 0.4, animation: "heart-beat-subtle", animationDuration: 3 },
            { asset: "scene-7c-letter-blank3.webp", top: 30, left: 12, width: 4, depth: 0.3, animation: "rotate-half", animationDuration: 2 },
            { asset: "scene-7c-letter-blank6.webp", top: 40, left: 20, width: 4, depth: 0.5, animation: "rotate-half-inverse", animationDuration: 1 },
            { asset: "scene-7c-letter-blank2.webp", top: 26, left: 71, width: 4, depth: 0.5 },
            { asset: "scene-7c-letter-blank7.webp", top: 50, left: 29, width: 6, depth: 0.3, animation: "heart-beat-subtle", animationDuration: 2.6 },
            { asset: "scene-7c-letter-blank8.webp", top: 54, left: 78, width: 4, depth: 0.5 },
            { asset: "scene-7c-letter-blank1.webp", top: 48, left: 88, width: 6, depth: 0.6, animation: "rotate-half", animationDuration: 3.6},
            { asset: "scene-7c-letter-blank3.webp", top: 18, left: 83, width: 4, depth: 0.7, animation: "rotate-half", animationDuration: 2.4 },
            { asset: "scene-7c-letter-blank7.webp", top: 5, left: 40, width: 4, depth: 0.2, animation: "rotate-half-inverse", animationDuration: 1 },
            { asset: "scene-7c-letter-blank5.webp", top: 8, left: 28, width: 6, depth: 0.7, animation: "heart-beat-subtle", animationDuration: 3.2 },
            { asset: "scene-7c-letter-blank2.webp", top: 18, left: 40, width: 4, depth: 0.3, animation: "heart-beat-subtle", animationDuration: 2.6 },
            { asset: "scene-7c-chest1.webp", top: 40, left: 38, width: 34, depth: 0.3, animation: "move-y", animationDuration: 7 },
        ],
        buttons: [
    ...
    },
    {
        ...
        elements: [
            ...
            { asset: "scene-8-b2.webp", top: 40, left: 25, width: 78, depth: 0.3, animation: "move-x", animationDuration: 3 },
            { asset: "scene-8-b1.webp", top: 45, left: 25, width: 78, depth: 0.4, animation: "move-x", animationDuration: 1.5 },
            { asset: "scene-8-balloon1.webp", top: 8, left: 53, width: 14.5, depth: 0.55, animation: "rotate-half-inverse", animationDuration: 2 },
            { asset: "scene-8-balloon3.webp", top: 28, left: 40, width: 10, depth: 0.36, animation: "wobble-x", animationDuration: 4, animationReverse: true },
            { asset: "scene-8-balloon4.webp", top: 28, left: 70, width: 10, depth: 0.48, animation: "move-x", animationDuration: 5 },
